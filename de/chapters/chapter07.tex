...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.75\linewidth]{bilder/mzi_and_simple.png} % <-- Pfad anpassen
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{bilder/photonen_grundlagenforschung.png} % <-- Pfad anpassen
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{bilder/photonen_ausblick_fixed.png} % <-- Pfad anpassen
