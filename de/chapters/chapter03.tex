...
\subsection{Gesundheitliche Aspekte elektromagnetischer  Strahlung}\index{Elektromagnetische Strahlung}\index{Gesundheit}
...
\subsubsection{Zusammenfassung -- Ionisierte und   Nicht-ionisierte Strahlung}
\medskip
...
\begin{table}[H]
	\centering
	\scriptsize
	\resizebox{0.95\linewidth}{!}{   % 0.95 = ca. 0,5 cm kleiner machen
...
\subsection{Masselosigkeit und Bewegung mit  Lichtgeschwindigkeit}\index{Masselosigkeit}\index{Lichtgeschwindigkeit}
